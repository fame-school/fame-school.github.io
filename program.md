...
Abstract: _This course provides an end-to-end coverage of the engineering of modeling languages to turn domain knowledge into tools. It introduces the foundations of Software Language Engineering (SLE), with a specific focus on the use of modeling techniques for designing and implementing DSLs. It also provides various illustrations through the definition of different kinds of modeling languages, their instrumentation with tools such as editors, interpreters/compilers, debuggers, and generators, the integration of multiple modeling languages to achieve a system view._

Bio: _[Benoit Combemale](http://combemale.fr) is currently Research Director at Inria, on leave from his position of Full Professor of Software Engineering at the University of Rennes. He is evolving within the research team DiverSE, joint to the CNRS Research Institute of Computer Science and Random Systems (IRISA) and Inria. He is also adjunct researcher in the SM@RT team of the CNRS Research Institute in Computer Science of Toulouse (IRIT), Scientific Advisor at TwiinIT and Editor-in-Chief of the Springer-Nature journal about Software and Systems Modeling (SoSyM). He is currently the scientific director of the 6 years French nationwide program about the engineering of digital twins (EDT, cf. edtlab.fr)._
...
Abstract: _Models earn their place in engineering by being the thing everything else is derived from: code, tests, configurations, safety evidence. That is exactly what makes them worth checking — and what makes checking them harder than it looks, because a model is simultaneously the artifact under scrutiny and the specification against which everything downstream is judged._

_This lecture builds a working frame for verification and validation of models. We start with what "right" can mean at each layer of an MDE stack — language, model, transformation, generated artifact — and with the observation that every V&V claim is relative to a property and a set of assumptions, the second of which is usually what hurts you. We then compare the four families of techniques actually available: review and well-formedness checking, simulation and testing, model finding and constraint solving, and model checking, with deductive verification at the expensive end. The comparison is about trade-offs rather than tools, and in particular about what each technique gives you when it fails._

_The second half turns to three places where the frame breaks down: transformations, where guarantees leak between the model you verified and the artifact you ship; uncertainty, where the model is not yet a single model; and variability, where it is deliberately many. We close on how learned components, LLMs, and assurance obligations are affecting all of it._

Bio: _Marsha Chechik is Professor and University Bell Labs Chair in Software Engineering in the Department of Computer Science at the University of Toronto. She received her Ph.D. from the University of Maryland. Prof. Chechik’s research interests are in the application of formal methods to improve the quality of software for all of its different users. She has authored numerous papers in formal methods, software specification and verification, computer safety and security, reliability and requirements engineering. She is a member of IFIP WG 2.9 on Requirements Engineering, an Editor in Chief of Journal on Software and Systems Modeling and a former Associate Editor in Chief of IEEE Transactions on Software Engineering.  She has served as Program Committee Co-Chair of the 2018 International Conference in Software Engineering (ICSE18), 2016 International Conference on Tools and Algorithms for the Construction and Analysis of Systems (TACAS’16),  the 2014 International Conference on Automated Software Engineering (ASE’14), the 2021 International Conference on Foundations of Software Engineering (ESEC/FSE'21), the 2023 International Conference on Formal Methods (FM'23) and the 2024 International Conference on Model Driven Engineering Languages and Systems (MODELS'24).  Marsha is Fellow of the ACM, Fellow of Automated Software Engineering and Chair of ACM Special Interest Group on Software Engineering._
